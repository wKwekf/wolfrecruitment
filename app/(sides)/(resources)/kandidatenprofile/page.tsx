...
Stellentitel: z.B. Senior Software Engineer
Tech Stack: z.B. React, Node.js, AWS
...
const faqs = [
  ...
  },
  {
    ...
    answer: "Unsere Profile sind handverlesen von Recruitern, die selbst einen technischen Hintergrund haben. Wir kennen den Tech-Markt in DACH und können die Qualifikationen der Kandidaten präzise einschätzen."
  }
]
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h1 className="font-platform text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium leading-tight">
                  Erhalte zwei kostenfreie Profile für deine Tech-Position
                </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    >
                      Ja, ich möchte weitere exklusive Einblicke zu Tech-Recruiting, relevante Kandidatenprofile und Branchentrends per E-Mail erhalten. Ich bin damit einverstanden, dass Wolf mich zu relevanten Angeboten, Events oder individuellen Recruiting-Lösungen kontaktiert. Ich kann mich jederzeit abmelden.
                    </Label>
                  </div>
                </div>
