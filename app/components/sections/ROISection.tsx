...
export default function ROISection() {
  ...
  useEffect(() => {
    ...
    if (section === 'roi' && sectionRef.current) {
      sectionRef.current.scrollIntoView({ behavior: 'smooth', block: 'start' });
      console.log('Scrolling to ROI section');
    }
  }, [sectionRef]);
  ...
  return (
    <section ref={sectionRef} id="roi" className="bg-[#121118] py-20">
      <TooltipProvider>
              ...
              <div className="flex items-center mb-2">
                ...
                <TooltipProvider delayDuration={0}>
                  <Tooltip>
                    ...
                    >
                      <p className="text-base">Die durchschnittliche Wertschöpfung eines Tech-Mitarbeiters liegt zwischen 2 und 3 und kann je nach Rolle deutlich höher sein.</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
              </div>
                  ...
                  <TooltipProvider delayDuration={0}>
                    <Tooltip>
                      ...
                      <TooltipContent 
                        ...
                        className="bg-[#2D2C35] text-white border border-gray-600 rounded-lg px-4 py-2 max-w-xs shadow-lg"
                      >
                        <p className="text-base">Die durchschnittliche Einstellungszeit für Tech-Positionen beträgt 121 Tage.</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
